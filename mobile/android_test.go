...
func TestAndroid(t *testing.T) {
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/Binacoin/gethtest", "libs"} {
	...
	if err = ioutil.WriteFile(filepath.Join("src", "androidTest", "java", "org", "Binacoin", "gethtest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
