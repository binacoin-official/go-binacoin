...
// Contains a wrapper for the Binacoin client.
...
import (
	...
	"github.com/binacoin-official/go-binacoin/bnaclient"
)

// BinacoinClient provides access to the Binacoin APIs.
type BinacoinClient struct {
	client *bnaclient.Client
}

// NewBinacoinClient connects a client to the given URL.
func NewBinacoinClient(rawurl string) (client *BinacoinClient, _ error) {
	rawClient, err := bnaclient.Dial(rawurl)
	return &BinacoinClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *BinacoinClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *BinacoinClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *BinacoinClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *BinacoinClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *BinacoinClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *BinacoinClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *BinacoinClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *BinacoinClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *BinacoinClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *BinacoinClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *BinacoinClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *BinacoinClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *BinacoinClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *BinacoinClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *BinacoinClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *BinacoinClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *BinacoinClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *BinacoinClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *BinacoinClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *BinacoinClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *BinacoinClient) SendTransaction(ctx *Context, tx *Transaction) error {
