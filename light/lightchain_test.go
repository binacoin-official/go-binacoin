...
func makeHeaderChain(parent *types.Header, n int, db bnadb.Database, seed int) []*types.Header {
...
// header only chain.
func newCanonical(n int) (bnadb.Database, *LightChain, error) {
...
func (odr *dummyOdr) Database() bnadb.Database {
	return odr.db
}
