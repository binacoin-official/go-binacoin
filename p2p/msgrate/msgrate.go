...
// most of Binacoin's existence, so might as well go with it.
...
// An Binacoin node doesn't need hundreds of connections to operate correctly,
...
type Tracker struct {
	...
	// (eg. bna.getHeaders vs snap.getAccountRange).
