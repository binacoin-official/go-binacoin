...
func TestCanonicalSynchronisation65Full(t *testing.T)  { testCanonSync(t, bna.ETH65, FullSync) }
func TestCanonicalSynchronisation65Fast(t *testing.T)  { testCanonSync(t, bna.ETH65, FastSync) }
func TestCanonicalSynchronisation65Light(t *testing.T) { testCanonSync(t, bna.ETH65, LightSync) }

func TestCanonicalSynchronisation66Full(t *testing.T)  { testCanonSync(t, bna.ETH66, FullSync) }
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, bna.ETH66, FastSync) }
func TestCanonicalSynchronisation66Light(t *testing.T) { testCanonSync(t, bna.ETH66, LightSync) }
...
func TestThrottling65Full(t *testing.T) { testThrottling(t, bna.ETH65, FullSync) }
func TestThrottling65Fast(t *testing.T) { testThrottling(t, bna.ETH65, FastSync) }

func TestThrottling66Full(t *testing.T) { testThrottling(t, bna.ETH66, FullSync) }
func TestThrottling66Fast(t *testing.T) { testThrottling(t, bna.ETH66, FastSync) }
...
func TestForkedSync65Full(t *testing.T)  { testForkedSync(t, bna.ETH65, FullSync) }
func TestForkedSync65Fast(t *testing.T)  { testForkedSync(t, bna.ETH65, FastSync) }
func TestForkedSync65Light(t *testing.T) { testForkedSync(t, bna.ETH65, LightSync) }

func TestForkedSync66Full(t *testing.T)  { testForkedSync(t, bna.ETH66, FullSync) }
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, bna.ETH66, FastSync) }
func TestForkedSync66Light(t *testing.T) { testForkedSync(t, bna.ETH66, LightSync) }
...
func TestHeavyForkedSync65Full(t *testing.T)  { testHeavyForkedSync(t, bna.ETH65, FullSync) }
func TestHeavyForkedSync65Fast(t *testing.T)  { testHeavyForkedSync(t, bna.ETH65, FastSync) }
func TestHeavyForkedSync65Light(t *testing.T) { testHeavyForkedSync(t, bna.ETH65, LightSync) }

func TestHeavyForkedSync66Full(t *testing.T)  { testHeavyForkedSync(t, bna.ETH66, FullSync) }
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, bna.ETH66, FastSync) }
func TestHeavyForkedSync66Light(t *testing.T) { testHeavyForkedSync(t, bna.ETH66, LightSync) }
...
// long dead chains.
func TestBoundedForkedSync65Full(t *testing.T)  { testBoundedForkedSync(t, bna.ETH65, FullSync) }
func TestBoundedForkedSync65Fast(t *testing.T)  { testBoundedForkedSync(t, bna.ETH65, FastSync) }
func TestBoundedForkedSync65Light(t *testing.T) { testBoundedForkedSync(t, bna.ETH65, LightSync) }

func TestBoundedForkedSync66Full(t *testing.T)  { testBoundedForkedSync(t, bna.ETH66, FullSync) }
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, bna.ETH66, FastSync) }
func TestBoundedForkedSync66Light(t *testing.T) { testBoundedForkedSync(t, bna.ETH66, LightSync) }
...
func TestBoundedHeavyForkedSync65Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH65, FullSync)
}
func TestBoundedHeavyForkedSync65Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH65, FastSync)
}
func TestBoundedHeavyForkedSync65Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH65, LightSync)
}

func TestBoundedHeavyForkedSync66Full(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH66, FullSync)
}
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH66, FastSync)
}
func TestBoundedHeavyForkedSync66Light(t *testing.T) {
	testBoundedHeavyForkedSync(t, bna.ETH66, LightSync)
}
...
func TestCancel65Full(t *testing.T)  { testCancel(t, bna.ETH65, FullSync) }
func TestCancel65Fast(t *testing.T)  { testCancel(t, bna.ETH65, FastSync) }
func TestCancel65Light(t *testing.T) { testCancel(t, bna.ETH65, LightSync) }

func TestCancel66Full(t *testing.T)  { testCancel(t, bna.ETH66, FullSync) }
func TestCancel66Fast(t *testing.T)  { testCancel(t, bna.ETH66, FastSync) }
func TestCancel66Light(t *testing.T) { testCancel(t, bna.ETH66, LightSync) }
...
func TestMultiSynchronisation65Full(t *testing.T)  { testMultiSynchronisation(t, bna.ETH65, FullSync) }
func TestMultiSynchronisation65Fast(t *testing.T)  { testMultiSynchronisation(t, bna.ETH65, FastSync) }
func TestMultiSynchronisation65Light(t *testing.T) { testMultiSynchronisation(t, bna.ETH65, LightSync) }

func TestMultiSynchronisation66Full(t *testing.T)  { testMultiSynchronisation(t, bna.ETH66, FullSync) }
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, bna.ETH66, FastSync) }
func TestMultiSynchronisation66Light(t *testing.T) { testMultiSynchronisation(t, bna.ETH66, LightSync) }
...
func TestMultiProtoSynchronisation65Full(t *testing.T)  { testMultiProtoSync(t, bna.ETH65, FullSync) }
func TestMultiProtoSynchronisation65Fast(t *testing.T)  { testMultiProtoSync(t, bna.ETH65, FastSync) }
func TestMultiProtoSynchronisation65Light(t *testing.T) { testMultiProtoSync(t, bna.ETH65, LightSync) }

func TestMultiProtoSynchronisation66Full(t *testing.T)  { testMultiProtoSync(t, bna.ETH66, FullSync) }
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, bna.ETH66, FastSync) }
func TestMultiProtoSynchronisation66Light(t *testing.T) { testMultiProtoSync(t, bna.ETH66, LightSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 65", bna.ETH65, chain)
	tester.newPeer("peer 66", bna.ETH66, chain)
...
func TestEmptyShortCircuit65Full(t *testing.T)  { testEmptyShortCircuit(t, bna.ETH65, FullSync) }
func TestEmptyShortCircuit65Fast(t *testing.T)  { testEmptyShortCircuit(t, bna.ETH65, FastSync) }
func TestEmptyShortCircuit65Light(t *testing.T) { testEmptyShortCircuit(t, bna.ETH65, LightSync) }

func TestEmptyShortCircuit66Full(t *testing.T)  { testEmptyShortCircuit(t, bna.ETH66, FullSync) }
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, bna.ETH66, FastSync) }
func TestEmptyShortCircuit66Light(t *testing.T) { testEmptyShortCircuit(t, bna.ETH66, LightSync) }
...
func TestMissingHeaderAttack65Full(t *testing.T)  { testMissingHeaderAttack(t, bna.ETH65, FullSync) }
func TestMissingHeaderAttack65Fast(t *testing.T)  { testMissingHeaderAttack(t, bna.ETH65, FastSync) }
func TestMissingHeaderAttack65Light(t *testing.T) { testMissingHeaderAttack(t, bna.ETH65, LightSync) }

func TestMissingHeaderAttack66Full(t *testing.T)  { testMissingHeaderAttack(t, bna.ETH66, FullSync) }
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, bna.ETH66, FastSync) }
func TestMissingHeaderAttack66Light(t *testing.T) { testMissingHeaderAttack(t, bna.ETH66, LightSync) }
...
func TestShiftedHeaderAttack65Full(t *testing.T)  { testShiftedHeaderAttack(t, bna.ETH65, FullSync) }
func TestShiftedHeaderAttack65Fast(t *testing.T)  { testShiftedHeaderAttack(t, bna.ETH65, FastSync) }
func TestShiftedHeaderAttack65Light(t *testing.T) { testShiftedHeaderAttack(t, bna.ETH65, LightSync) }

func TestShiftedHeaderAttack66Full(t *testing.T)  { testShiftedHeaderAttack(t, bna.ETH66, FullSync) }
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, bna.ETH66, FastSync) }
func TestShiftedHeaderAttack66Light(t *testing.T) { testShiftedHeaderAttack(t, bna.ETH66, LightSync) }
...
func TestInvalidHeaderRollback65Fast(t *testing.T) { testInvalidHeaderRollback(t, bna.ETH65, FastSync) }
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, bna.ETH66, FastSync) }
...
func TestHighTDStarvationAttack65Full(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH65, FullSync)
}
func TestHighTDStarvationAttack65Fast(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH65, FastSync)
}
func TestHighTDStarvationAttack65Light(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH65, LightSync)
}

func TestHighTDStarvationAttack66Full(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH66, FullSync)
}
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH66, FastSync)
}
func TestHighTDStarvationAttack66Light(t *testing.T) {
	testHighTDStarvationAttack(t, bna.ETH66, LightSync)
}
...
func TestBlockHeaderAttackerDropping65(t *testing.T) { testBlockHeaderAttackerDropping(t, bna.ETH65) }
func TestBlockHeaderAttackerDropping66(t *testing.T) { testBlockHeaderAttackerDropping(t, bna.ETH66) }
...
func TestSyncProgress65Full(t *testing.T)  { testSyncProgress(t, bna.ETH65, FullSync) }
func TestSyncProgress65Fast(t *testing.T)  { testSyncProgress(t, bna.ETH65, FastSync) }
func TestSyncProgress65Light(t *testing.T) { testSyncProgress(t, bna.ETH65, LightSync) }

func TestSyncProgress66Full(t *testing.T)  { testSyncProgress(t, bna.ETH66, FullSync) }
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, bna.ETH66, FastSync) }
func TestSyncProgress66Light(t *testing.T) { testSyncProgress(t, bna.ETH66, LightSync) }
...
// revertal).
func TestForkedSyncProgress65Full(t *testing.T)  { testForkedSyncProgress(t, bna.ETH65, FullSync) }
func TestForkedSyncProgress65Fast(t *testing.T)  { testForkedSyncProgress(t, bna.ETH65, FastSync) }
func TestForkedSyncProgress65Light(t *testing.T) { testForkedSyncProgress(t, bna.ETH65, LightSync) }

func TestForkedSyncProgress66Full(t *testing.T)  { testForkedSyncProgress(t, bna.ETH66, FullSync) }
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, bna.ETH66, FastSync) }
func TestForkedSyncProgress66Light(t *testing.T) { testForkedSyncProgress(t, bna.ETH66, LightSync) }
...
func TestFailedSyncProgress65Full(t *testing.T)  { testFailedSyncProgress(t, bna.ETH65, FullSync) }
func TestFailedSyncProgress65Fast(t *testing.T)  { testFailedSyncProgress(t, bna.ETH65, FastSync) }
func TestFailedSyncProgress65Light(t *testing.T) { testFailedSyncProgress(t, bna.ETH65, LightSync) }

func TestFailedSyncProgress66Full(t *testing.T)  { testFailedSyncProgress(t, bna.ETH66, FullSync) }
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, bna.ETH66, FastSync) }
func TestFailedSyncProgress66Light(t *testing.T) { testFailedSyncProgress(t, bna.ETH66, LightSync) }
...
func TestFakedSyncProgress65Full(t *testing.T)  { testFakedSyncProgress(t, bna.ETH65, FullSync) }
func TestFakedSyncProgress65Fast(t *testing.T)  { testFakedSyncProgress(t, bna.ETH65, FastSync) }
func TestFakedSyncProgress65Light(t *testing.T) { testFakedSyncProgress(t, bna.ETH65, LightSync) }

func TestFakedSyncProgress66Full(t *testing.T)  { testFakedSyncProgress(t, bna.ETH66, FullSync) }
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, bna.ETH66, FastSync) }
func TestFakedSyncProgress66Light(t *testing.T) { testFakedSyncProgress(t, bna.ETH66, LightSync) }
...
func TestDeliverHeadersHang65Full(t *testing.T)  { testDeliverHeadersHang(t, bna.ETH65, FullSync) }
func TestDeliverHeadersHang65Fast(t *testing.T)  { testDeliverHeadersHang(t, bna.ETH65, FastSync) }
func TestDeliverHeadersHang65Light(t *testing.T) { testDeliverHeadersHang(t, bna.ETH65, LightSync) }

func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, bna.ETH66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, bna.ETH66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, bna.ETH66, LightSync) }
...
func TestCheckpointEnforcement65Full(t *testing.T) { testCheckpointEnforcement(t, bna.ETH65, FullSync) }
func TestCheckpointEnforcement65Fast(t *testing.T) { testCheckpointEnforcement(t, bna.ETH65, FastSync) }
func TestCheckpointEnforcement65Light(t *testing.T) {
	testCheckpointEnforcement(t, bna.ETH65, LightSync)
}

func TestCheckpointEnforcement66Full(t *testing.T) { testCheckpointEnforcement(t, bna.ETH66, FullSync) }
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, bna.ETH66, FastSync) }
func TestCheckpointEnforcement66Light(t *testing.T) {
	testCheckpointEnforcement(t, bna.ETH66, LightSync)
}
