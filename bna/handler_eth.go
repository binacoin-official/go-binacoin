...
// ethHandler implements the bna.Backend interface to handle the various network
// packets that are sent as replies or broadcasts.
type ethHandler handler

func (h *ethHandler) Chain() *core.BlockChain     { return h.chain }
func (h *ethHandler) StateBloom() *trie.SyncBloom { return h.stateBloom }
func (h *ethHandler) TxPool() bna.TxPool          { return h.txpool }

// RunPeer is invoked when a peer joins on the `bna` protocol.
func (h *ethHandler) RunPeer(peer *bna.Peer, hand bna.Handler) error {
...
func (h *ethHandler) Handle(peer *bna.Peer, packet bna.Packet) error {
...
func (h *ethHandler) handleHeaders(peer *bna.Peer, headers []*types.Header) error {
...
func (h *ethHandler) handleBodies(peer *bna.Peer, txs [][]*types.Transaction, uncles [][]*types.Header) error {
...
func (h *ethHandler) handleBlockAnnounces(peer *bna.Peer, hashes []common.Hash, numbers []uint64) error {
...
func (h *ethHandler) handleBlockBroadcast(peer *bna.Peer, block *types.Block, td *big.Int) error {
