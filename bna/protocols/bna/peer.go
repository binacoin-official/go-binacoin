...
// Peer is a collection of relevant information we have about a `bna` peer.
type Peer struct {
...
// Version retrieves the peer's negoatiated `bna` protocol version.
...
// ReplyPooledTransactionsRLP is the bna/66 version of SendPooledTransactionsRLP.
...
// ReplyBlockHeaders is the bna/66 version of SendBlockHeaders.
...
// ReplyBlockBodiesRLP is the bna/66 version of SendBlockBodiesRLP.
...
// ReplyNodeData is the bna/66 response to GetNodeData.
...
// ReplyReceiptsRLP is the bna/66 response to GetReceipts.
