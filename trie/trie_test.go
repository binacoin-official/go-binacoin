...
func (s *spongeDb) NewBatch() bnadb.Batch                    { return &spongeBatch{s} }
...
func (s *spongeDb) NewIterator(prefix []byte, start []byte) bnadb.Iterator { panic("implement me") }
...
func (b *spongeBatch) Replay(w bnadb.KeyValueWriter) error { return nil }
