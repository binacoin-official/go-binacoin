...
type NodeIterator interface {
	...
	//
	// Before adding a similar mechanism to any other place in Gbina, consider
	// making trie.Database an interface and wrapping at that level. It's a huge
	// refactor, but it could be worth it if another occurrence arises.
	AddResolver(bnadb.KeyValueStore)
}
...
type nodeIterator struct {
	...
	resolver bnadb.KeyValueStore // Optional intermediate resolver above the disk layer
}
...
func (it *nodeIterator) AddResolver(resolver bnadb.KeyValueStore) {
...
func (it *differenceIterator) AddResolver(resolver bnadb.KeyValueStore) {
...
func (it *unionIterator) AddResolver(resolver bnadb.KeyValueStore) {
	panic("not implemented")
}
