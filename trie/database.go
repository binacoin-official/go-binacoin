...
type Database struct {
	diskdb bnadb.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb bnadb.KeyValueStore) *Database {
...
func NewDatabaseWithConfig(diskdb bnadb.KeyValueStore, config *Config) *Database {
...
func (db *Database) DiskDB() bnadb.KeyValueStore {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch bnadb.Batch, uncacher *cleaner, callback func(common.Hash)) error {
