...
const schema string = `
    ...
    scalar Bytes32
    # Address is a 20 byte Binacoin address, represented as 0x-prefixed hexadecimal.
    scalar Address
    ...
    # Account is an Binacoin account at a particular block.
    type Account {
    ...
    # Transaction is an Binacoin transaction.
    type Transaction {
    ...
    type Block {
        ...
        # Account fetches an Binacoin account at the current block's state.
    ...
    type Pending {
      ...
      transactions: [Transaction!]
      # Account fetches an Binacoin account for the pending state.
      account(address: Address!): Account!
    ...
    type Query {
        # Block fetches an Binacoin block by number or by hash. If neither is
