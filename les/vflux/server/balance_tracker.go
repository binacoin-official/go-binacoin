...
func newBalanceTracker(ns *nodestate.NodeStateMachine, setup *serverSetup, db bnadb.KeyValueStore, clock mclock.Clock, posExp, negExp utils.ValueExpirer) *balanceTracker {
