...
import (
	...
	"github.com/binacoin-official/go-binacoin/p2p/simulations"
	"github.com/binacoin-official/go-binacoin/p2p/simulations/adapters"
...
func getHead(ctx context.Context, t *testing.T, client *rpc.Client) (uint64, common.Hash) {
	...
	if err := client.CallContext(ctx, &res, "bna_getBlockByNumber", "latest", false); err != nil {
...
func testRequest(ctx context.Context, t *testing.T, client *rpc.Client) bool {
	...
	defer cancel()
	err := client.CallContext(c, &res, "bna_getBalance", addr, "latest")
	if err != nil {
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	binacoin, err := bna.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, binacoin, &config)
	if err != nil {
		return nil, err
	}
	return binacoin, nil
