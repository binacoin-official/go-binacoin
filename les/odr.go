...
func NewLesOdr(db bnadb.Database, config *light.IndexerConfig, peers *serverPeerSet, retriever *retrieveManager) *LesOdr {
	return &LesOdr{
		db:            db,
...
func (odr *LesOdr) Database() bnadb.Database {
	return odr.db
}
