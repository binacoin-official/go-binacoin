...
type accessTestFn func(db bnadb.Database, bhash common.Hash, number uint64) light.OdrRequest
...
func tfBlockAccess(db bnadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfReceiptsAccess(db bnadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfTrieEntryAccess(db bnadb.Database, bhash common.Hash, number uint64) light.OdrRequest {
...
func tfCodeAccess(db bnadb.Database, bhash common.Hash, num uint64) light.OdrRequest {
