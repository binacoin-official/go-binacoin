...
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://github.com/binacoin-official/go-binacoin/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
...
Use the built-in `geth version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://geth.Binacoin.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `geth`, and cross-check the data against its own version number.
