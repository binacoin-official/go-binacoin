...
Please see [Releases](https://github.com/binacoin-official/go-binacoin/releases). We recommend using the [most recently released version](https://github.com/binacoin-official/go-binacoin/releases/latest).

## Audit reports

Audit reports are published in the `docs` folder: https://github.com/binacoin-official/go-binacoin/tree/master/docs/audits 

| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `gbina` | 20170425 | [pdf](https://github.com/binacoin-official/go-binacoin/blob/master/docs/audits/2017-04-25_Gbina-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://github.com/binacoin-official/go-binacoin/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |

## Reporting a Vulnerability

**Please do not file a public ticket** mentioning the vulnerability.

To find out how to disclose a vulnerability in Binacoin visit [https://bounty.binacoin.org](https://bounty.binacoin.org) or email bounty@binacoin.org. Please read the [disclosure page](https://github.com/binacoin-official/go-binacoin/security/advisories?state=published) for more information about publically disclosed security vulnerabilities.

Use the built-in `gbina version-check` feature to check whether the software is affected by any known vulnerability. This command will fetch the latest [`vulnerabilities.json`](https://gbina.binacoin.org/docs/vulnerabilities/vulnerabilities.json) file which contains known security vulnerabilities concerning `gbina`, and cross-check the data against its own version number.
