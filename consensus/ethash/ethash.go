...
// all blocks' seal as valid, though they still have to conform to the Binacoin
// consensus rules.
...
// still have to conform to the Binacoin consensus rules.
...
// they still have to conform to the Binacoin consensus rules.
...
func (ethash *Ethash) APIs(chain consensus.ChainHeaderReader) []rpc.API {
	...
	// to both bna and ethash namespaces.
	return []rpc.API{
		{
			Namespace: "bna",
			Version:   "1.0",
