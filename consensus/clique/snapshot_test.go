...
// mapped from textual names used in the tests below to actual Binacoin private
...
// address retrieves the Binacoin address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Binacoin address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/binacoin-official/go-binacoin/issues/17593). Whilst this
