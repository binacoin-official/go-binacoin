...
// ecrecover extracts the Binacoin account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Binacoin address
...
// Binacoin testnet following the Ropsten attacks.
type Clique struct {
	config *params.CliqueConfig // Consensus engine configuration parameters
	db     bnadb.Database       // Database to store and retrieve snapshot checkpoints
	...
	signer common.Address // Binacoin address of the signing key
...
func New(config *params.CliqueConfig, db bnadb.Database) *Clique {
...
// Author implements consensus.Engine, returning the Binacoin address recovered
