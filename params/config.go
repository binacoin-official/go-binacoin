...
var (
	...
	// and accepted by the Binacoin core developers into the Ethash consensus.
	//
	...
	// and accepted by the Binacoin core developers into the Clique consensus.
	//
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whbither the nodes supports or opposes the DAO hard-fork

	// EIP150 implements the Gas price changes (https://github.com/binacoin-official/EIPs/issues/150)
...
// CheckConfigForkOrder checks that we don't "skip" any forks, gbina isn't pluggable enough
