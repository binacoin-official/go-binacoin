...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/binacoin-official/pybnasaletool

		pybnasaletool generates the encryption key from password by
	...
	*/
	...
	bnqPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(bnaPriv)
	...
	expectedAddr := preSaleKeyStruct.BnaAddr
