...
// See https://github.com/binacoin-official/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whbither the event notification loop is running
...
// ImportPreSaleKey decrypts the given Binacoin presale wallet and stores
