...
func (mc *mockCaller) CallContract(ctx context.Context, call binacoin.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call binacoin.CallMsg) ([]byte, error) {
