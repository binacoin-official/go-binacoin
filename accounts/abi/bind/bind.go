...
// Package bind generates Binacoin contract Go bindings.
//
// Detailed usage document and tutorial available on the go-binacoin Wiki page:
// https://github.com/binacoin-official/go-binacoin/wiki/Native-DApps:-Go-bindings-to-Binacoin-contracts
package bind
