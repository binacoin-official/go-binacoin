...
var (
	...
	skipPrefixes = []string{
		...
		"crypto/secp256k1", // Relicensed to BSD-3 via https://github.com/binacoin-official/go-binacoin/pull/17225
	}
	...
	authorsFileHeader = "# This is the official list of go-binacoin authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-binacoin Authors
...
func (i info) Whole(startOfSentence bool) string {
	...
	if startOfSentence {
		return "The go-binacoin library"
	}
	return "the go-binacoin library"
}
