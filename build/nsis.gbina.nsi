...
# 1. install gbina for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gbina
# 5. create gbina, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable BINACOIN_SOCKET
...
!define GROUPNAME "Binacoin"
!define APPNAME "Gbina"
!define DESCRIPTION "Official Go implementation of the Binacoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gbina is installed global
