...
func doDocker(cmdline []string) {
	...
	//  - Binacoin/client-go:latest                            - Pushes to the master branch, Geth only
	//  - Binacoin/client-go:stable                            - Version tag publish on GitHub, Geth only
	//  - Binacoin/client-go:alltools-latest                   - Pushes to the master branch, Geth & tools
	//  - Binacoin/client-go:alltools-stable                   - Version tag publish on GitHub, Geth & tools
	//  - Binacoin/client-go:release-<major>.<minor>           - Version tag publish on GitHub, Geth only
	//  - Binacoin/client-go:alltools-release-<major>.<minor>  - Version tag publish on GitHub, Geth & tools
	//  - Binacoin/client-go:v<major>.<minor>.<patch>          - Version tag publish on GitHub, Geth only
	//  - Binacoin/client-go:alltools-v<major>.<minor>.<patch> - Version tag publish on GitHub, Geth & tools
	var tags []string
