...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*bnaapi.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx bnaapi.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*bnaapi.SignTransactionResult, error) {
	var (
		err    error
	...
	response := bnaapi.SignTransactionResult{Raw: data, Tx: signedTx}
