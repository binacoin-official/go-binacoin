...
func (alwaysDenyUI) OnApprovedTx(tx bnaapi.SignTransactionResult) {
	panic("implement me")
}
...
func (d *dummyUI) OnApprovedTx(tx bnaapi.SignTransactionResult) {
...
func TestForwarding(t *testing.T) {
	...
	r.OnApprovedTx(bnaapi.SignTransactionResult{})
...
func TestLimitWindow(t *testing.T) {
	...
	// 0.3 bither: 429D069189E0000 wei
	...
	for i := 0; i < 3; i++ {
		...
		response := bnaapi.SignTransactionResult{
			Tx:  dummySigned(v),
...
func (d *dontCallMe) OnApprovedTx(tx bnaapi.SignTransactionResult) {
	d.t.Fatalf("Did not expect next-handler to be called")
}
