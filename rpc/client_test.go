	...
	check := func(shouldPanic bool, arg interface{}) {
		defer func() {
			...
			if shouldPanic && err == nil {
				t.Errorf("BnaSubscribe should've panicked for %#v", arg)
			}
			if !shouldPanic && err != nil {
				t.Errorf("BnaSubscribe shouldn't have panicked for %#v", arg)
		...
		client.BnaSubscribe(context.Background(), arg, "foo_bar")
	}
	check(true, nil)
	check(true, 1)
...
// This test reproduces https://github.com/binacoin-official/go-binacoin/issues/17837 where the
...
// It is the reproducer for https://github.com/binacoin-official/go-binacoin/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-binacoin-test-ipc-%d-%d", os.Getpid(), rand.Int63())
