...
//
// bna_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// bna_subscribe("newHeads")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.BnaSubscribe(ctx, subch, "newHeads")
	if err != nil {
	...
	var lastBlock Block
	err = client.CallContext(ctx, &lastBlock, "bna_getBlockByNumber", "latest", false)
	if err != nil {
