...
type requestOp struct {
	...
	sub  *ClientSubscription  // only set for BnaSubscribe requests
}
...
// BnaSubscribe registers a subscripion under the "bna" namespace.
func (c *Client) BnaSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "bna", channel, args...)
}
