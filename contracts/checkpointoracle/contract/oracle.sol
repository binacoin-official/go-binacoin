 ...
 * @author Gary Rong<garyrong@Binacoin.org>, Martin Swende <martin.swende@Binacoin.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the Binacoin.
    uint sectionSize;
