...
Then, run the following command, replacing `<enode>` with the enode of the geth node:
 ```
 devp2p rlpx bna-test <enode> cmd/devp2p/internal/ethtest/testdata/chain.rlp cmd/devp2p/internal/ethtest/testdata/genesis.json
```
...
The Eth66 test suite is also a conformance test suite for the bna 66 protocol version specifically.
...
[bna]: https://github.com/Binacoin/devp2p/blob/master/caps/bna.md
[dns-tutorial]: https://geth.Binacoin.org/docs/developers/dns-discovery-setup
[discv4]: https://github.com/Binacoin/devp2p/tree/master/discv4.md
[discv5]: https://github.com/Binacoin/devp2p/tree/master/discv5/discv5.md
