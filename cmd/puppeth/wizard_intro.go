...
// setting up a new or managing an existing Binacoin private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Binacoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Binacoin network down to  |")
	fmt.Println("| the genesis block, bootnodes, miners and bnastats servers |")
	...
	log.Info("Administering Binacoin network", "name", w.network)
