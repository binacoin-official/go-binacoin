...
// Tests the go-binacoin to Aleth chainspec conversion for the Stureby testnet.
func TestAlethSturebyConverter(t *testing.T) {
	blob, err := ioutil.ReadFile("testdata/stureby_gbina.json")
	if err != nil {
...
// Tests the go-binacoin to Parity chainspec conversion for the Stureby testnet.
