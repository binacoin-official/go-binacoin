...
func makeConfigNode(ctx *cli.Context) (*node.Node, gethConfig) {
	...
	utils.SetEthConfig(ctx, stack, &cfg.bna)
...
// makeFullNode loads geth configuration and creates the Binacoin backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	backend, bna := utils.RegisterEthService(stack, &cfg.bna)
