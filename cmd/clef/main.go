...
import (
	...
	"github.com/binacoin-official/go-binacoin/signer/core"
	"github.com/binacoin-official/go-binacoin/signer/fourbyte"
	"github.com/binacoin-official/go-binacoin/signer/rules"
	"github.com/binacoin-official/go-binacoin/signer/storage"
...
var (
	...
	chainIdFlag = cli.Int64Flag{
		...
		Usage: "Chain id to use for signing (9834=mainnet, 3=Ropsten, 4=Rinkeby, 9835=Goerli)",
	}
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage Binacoin account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
...
func checkFile(filename string) error {
	...
	// https://github.com/binacoin-official/go-binacoin/issues/20123
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("0x0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"Bither Mail","version":"1","chainId":"1","verifyingContract":"0xCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"0xcD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
...
func GenDoc(ctx *cli.Context) {
	...
	{ // WHen a signed tx is ready to go out
		...
		add("OnApproved - SignTransactionResult", desc, &bnaapi.SignTransactionResult{Raw: rlpdata, Tx: &tx})
