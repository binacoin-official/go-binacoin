...
In this case, `geth` would be started with `--signer http://localhost:8550` and would relay requests to `bna.sendTransaction`.
...
The signer will generate a new private key, encrypt it according to [web3 keystore spec](https://github.com/Binacoin/wiki/wiki/Web3-Secret-Storage-Definition) and store it in the keystore directory.  
...
#### Arguments
  - content type [string]: type of signed data
     ...
     - `application/clique`: [clique](https://github.com/Binacoin/EIPs/issues/225) headers
...
#### Sign data
   Signs a chunk of structured data conformant to [EIP-712](https://github.com/Binacoin/EIPs/blob/master/EIPS/eip-712.md) and returns the calculated signature.
...
| Clef UI| https://github.com/Binacoin/clef-ui| Golang/QT-based| :+1:| :+1:| :x:| :+1:| :+1:| :x: |  :+1: (approve tx only)|
