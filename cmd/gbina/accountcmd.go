...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Binacoin presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gbina wallet import /path/to/my/presale.wallet

will prompt for your password and imports your bither presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Binacoin presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	gbina wallet [options] /path/to/my/presale.wallet
...
between binacoin nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gbina account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gbina account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another binacoin instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gbinaConfig{Node: defaultNodeConfig()}
	// Load config file.
