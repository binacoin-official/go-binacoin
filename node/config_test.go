...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbina.ipc", false, filepath.Join(os.TempDir(), "gbina.ipc")},
		{"data", "gbina.ipc", false, "data/gbina.ipc"},
		{"data", "./gbina.ipc", false, "./gbina.ipc"},
		{"data", "/gbina.ipc", false, "/gbina.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbina.ipc", true, `\\.\pipe\gbina.ipc`},
		{"data", "gbina.ipc", true, `\\.\pipe\gbina.ipc`},
		{"data", `\\.\pipe\gbina.ipc`, true, `\\.\pipe\gbina.ipc`},
	}
