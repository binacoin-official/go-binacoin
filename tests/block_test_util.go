...
// Package tests implements execution of Binacoin JSON tests.
package tests
...
/* See https://github.com/binacoin-official/tests/wiki/Blockchain-Tests-II

   Whbither a block is valid or not is a bit subtle, it's defined by presence of
