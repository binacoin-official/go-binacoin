...
func SetupGenesisBlock(db bnadb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}

func SetupGenesisBlockWithOverride(db bnadb.Database, genesis *Genesis, overrideLondon *big.Int) (*params.ChainConfig, common.Hash, error) {
...
func (g *Genesis) ToBlock(db bnadb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db bnadb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db bnadb.Database) *types.Block {
...
func GenesisBlockForTesting(db bnadb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{
...
// DefaultGenesisBlock returns the Binacoin main net genesis block.
...
// DeveloperGenesisBlock returns the 'gbina --dev' genesis block.
