...
func wipeSnapshot(db bnadb.KeyValueStore, full bool) chan struct{} {
...
func wipeContent(db bnadb.KeyValueStore) error {
...
func wipeKeyRange(db bnadb.KeyValueStore, kind string, prefix []byte, origin []byte, limit []byte, keylen int, meter metrics.Meter, report bool) error {
