...
// Package state provides a caching layer atop the Binacoin state trie.
package state
...
// StateDB structs within the binacoin protocol are used to store anything
...
//
// Carrying over the balance ensures that Bither doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/binacoin-official/go-binacoin/pull/16485#issuecomment-380438527),
