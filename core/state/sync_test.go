...
// account array.
func checkStateAccounts(t *testing.T, db bnadb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db bnadb.Database, root common.Hash) error {
...
func checkStateConsistency(db bnadb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(bnadb.Database), srcRoot)
