...
// stateObject represents an Binacoin account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of Binacoin address of the account
	data     Account
	db       *StateDB
...
// Account is the Binacoin consensus representation of accounts.
