...
// Package types contains data types related to Binacoin consensus.
package types
...
// Header represents a block header in the Binacoin blockchain.
type Header struct {
...
// Block represents an entire block in the Binacoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
	...
	// These fields are used by package bna to track
	// inter-peer block relay.
	ReceivedAt   time.Time
	ReceivedFrom interface{}
}

// "external" block encoding. used for bna protocol, etc.
...
// DecodeRLP decodes the Binacoin
...
// EncodeRLP serializes b into the Binacoin RLP block format.
