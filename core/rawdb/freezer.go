...
//   reserving it for go-binacoin. This would also reduce the memory requirements
//   of Gbina, and thus also GC overhead.
type freezer struct {
...
func (f *freezer) freeze(db bnadb.KeyValueStore) {
