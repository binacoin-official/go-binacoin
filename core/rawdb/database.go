...
import (
	...
	"github.com/binacoin-official/go-binacoin/bnadb/leveldb"
	"github.com/binacoin-official/go-binacoin/bnadb/memorydb"
...
func NewDatabase(db bnadb.KeyValueStore) bnadb.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db bnadb.KeyValueStore, freezer string, namespace string, readonly bool) (bnadb.Database, error) {
...
func NewMemoryDatabase() bnadb.Database {
...
func NewMemoryDatabaseWithCap(size int) bnadb.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string, readonly bool) (bnadb.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string, readonly bool) (bnadb.Database, error) {
...
func InspectDatabase(db bnadb.Database, keyPrefix, keyStart []byte) error {
