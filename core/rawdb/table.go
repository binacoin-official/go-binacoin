...
func NewTable(db bnadb.Database, prefix string) bnadb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator(prefix []byte, start []byte) bnadb.Iterator {
...
func (t *table) NewBatch() bnadb.Batch {
...
func (b *tableBatch) Replay(w bnadb.KeyValueWriter) error {
