...
// It can be used for testing that restart Gbina normally.
...
// It can be used for testing that restart Gbina after the crash.
...
// Tests a Gbina restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gbina was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gbina was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gbina was running with snapshot enabled. Then restarts without
...
// Tests the Gbina was running with snapshot enabled and resetHead is applied.
...
// Tests the Gbina was running with a complete snapshot and then imports a few
