...
import (
	...
	cmath "github.com/binacoin-official/go-binacoin/common/math"
...
func (st *StateTransition) preCheck() error {
	...
	if st.evm.ChainConfig().IsLondon(st.evm.Context.BlockNumber) {
		// Skip the checks if gas fields are zero and baseFee was explicitly disabled (bna_call)
...
func (st *StateTransition) refundGas(refundQuotient uint64) {
	...
	// Return bna for remaining gas, exchanged at the original rate.
