...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (bnadb.Database, *BlockChain, error) {
	var (
...
func TestLightVsFastVsFullChainHeads(t *testing.T) {
	...
	makeDb := func() (bnadb.Database, func()) {
...
//
// https://github.com/binacoin-official/go-binacoin/pull/15941
...
//
// Details at:
//  - https://github.com/binacoin-official/go-binacoin/issues/18977
//  - https://github.com/binacoin-official/go-binacoin/pull/18988
...
//   with 0.001 bither (thus created but no code)
...
func TestEIP1559Transition(t *testing.T) {
	var (
		...
		addr1   = crypto.PubkeyToAddress(key1.PublicKey)
		addr2   = crypto.PubkeyToAddress(key2.PublicKey)
		funds   = new(big.Int).Mul(common.Big1, big.NewInt(params.Bither))
		gspec   = &Genesis{
