...
// Package forkid implements EIP-2124 (https://eips.binacoin.org/EIPS/eip-2124).
package forkid
...
// NewID calculates the Binacoin fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Binacoin fork ID from an existing chain instance.
