...
func main() {
	...
	for _, sealer := range sealers {
		...
		stack, bnaBackend, err := makeSealer(genesis)
		if err != nil {
			panic(err)
		}
		defer stack.Close()
...
func makeSealer(genesis *core.Genesis) (*node.Node, *bna.Binacoin, error) {
	...
	// Start the node and configure a full Binacoin node on it
