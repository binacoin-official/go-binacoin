...
// TestMinerSetBitherbase checks that bitherbase becomes set even if mining isn't
// possible at the moment
func TestMinerSetBitherbase(t *testing.T) {
	miner, mux := createMiner(t)
...
func createMiner(t *testing.T) (*Miner, *event.TypeMux) {
	...
	config := Config{
		Bitherbase: common.HexToAddress("123456789"),
	}
	// Create chainConfig
	memdb := memorydb.New()
