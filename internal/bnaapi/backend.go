...
// Package bnaapi implements the general Binacoin API functions.
package bnaapi
...
type Backend interface {
	...
	ExtRPCEnabled() bool
	RPCGasCap() uint64        // global gas cap for bna_call over rpc: DoS protection
	...
	return []rpc.API{
		{
			Namespace: "bna",
			Version:   "1.0",
			Service:   NewPublicBinacoinAPI(apiBackend),
			Public:    true,
		}, {
			Namespace: "bna",
			Version:   "1.0",
