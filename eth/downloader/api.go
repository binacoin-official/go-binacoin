...
// Syncing provides information when this nodes starts synchronising with the Binacoin network and when it's finished.
...
type SyncingResult struct {
	...
	Status  binacoin.SyncProgress `json:"status"`
}
