...
// NewAPI creates a new API definition for the tracing methods of the Binacoin service.
...
func (api *API) TraceCall(ctx context.Context, args bnaapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
...
func (api *API) traceTx(ctx context.Context, message core.Message, txctx *Context, vmctx vm.BlockContext, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
	...
	case *vm.StructLogger:
		...
		return &bnaapi.ExecutionResult{
			Gas:         result.UsedGas,
			Failed:      result.Failed(),
			ReturnValue: returnVal,
			StructLogs:  bnaapi.FormatLogs(tracer.StructLogs()),
		}, nil
