...
// TestBna66EmptyMessages tests encoding of empty bna66 messages
func TestBna66EmptyMessages(t *testing.T) {
...
// TestBna66Messages tests the encoding of all redefined bna66 messages
func TestBna66Messages(t *testing.T) {
