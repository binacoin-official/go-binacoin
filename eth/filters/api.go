...
// information related to the Binacoin protocol such als blocks, transactions and logs.
...
//
// https://bna.wiki/json-rpc/API#eth_newpendingtransactionfilter
...
//
// https://bna.wiki/json-rpc/API#eth_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(binacoin.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
// Same as binacoin.FilterQuery but with UnmarshalJSON() method.
type FilterCriteria binacoin.FilterQuery
...
//
// https://bna.wiki/json-rpc/API#eth_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(binacoin.FilterQuery(crit), logs)
	if err != nil {
		return "", err
	}
...
//
// https://bna.wiki/json-rpc/API#eth_getlogs
...
//
// https://bna.wiki/json-rpc/API#eth_uninstallfilter
...
//
// https://bna.wiki/json-rpc/API#eth_getfilterlogs
...
//
// https://bna.wiki/json-rpc/API#eth_getfilterchanges
